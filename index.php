    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form class="login-form" action="proseslogin.php" method="post">
                ...
                <button href="index.php" class="btn btn-primary pull-right" type="submit">Sign In</button>
                
                <div class="clearfix"></div>
            </form>
        </div>
    </div>
    <p class="pull-right" style=""><a href="http://www.portnine.com" target="blank" style="font-size: .75em; margin-top: .25em;">Design by SPAN Community</a></p>
