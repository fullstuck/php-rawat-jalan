  ...
  <!--<![endif]-->
	...
	<b><?php $tampil=mysqli_query($koneksi, "select * from tb_obat order by id_obat desc");
		...
		<!-- End --></span> Obat</p>
            ...
            <h1 class="page-title">Edit Data Dokter</h1>
                    <ul class="breadcrumb">
            ...
            <li class="active">Edit Data Dokter</li>
					 ...
					 <!-- Fungsi Memasukkan Data kedalam Database -->
							<?php
							$query = mysqli_query($koneksi, "SELECT * FROM tb_dokter WHERE id_dokter='$_GET[kd]'");
...
<div class="row">
     ...
     <div class="col-md-12 col-sm-12">
                         ...
                         <div class="alert alert-default alert-gradient alert-dismissible fade in" role="alert">
                           <strong><h4> Edit Data Dokter</h4></strong>
                        </div>
						  
						  <!-- Fungsi Form Tambah Data Kasir -->
                            <div class="panel-body">
                              <div class="form">
                                  <form class="form-horizontal style-form" action="update-dokter.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
									
									 <div class="form-group ">
                                          <label for="id_dokter" class="control-label col-lg-2">ID Dokter </label>
                                          <div class="col-lg-2">
                                              <input class="form-control" id="id_dokter" type="text" name="id_dokter" value="<?php echo $data['id_dokter'];?>" readonly="readonly" autofocus="on"/>
                                          </div>
                                      </div>
									...
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-4">
                                              <input class="form-control" id="nama_dokter" name="nama_dokter" type="text" value="<?php echo $data['nama_dokter'];?>" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="spesialisasi" class="control-label col-lg-2">Spesialisasi </label>
                                          <div class="col-lg-5">
                                              <input class="form-control" id="spesialisasi" type="text" name="spesialisasi" value="<?php echo $data['spesialisasi'];?>" />
                                          </div>
                                      </div>
