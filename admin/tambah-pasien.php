					...
					<?php
						if(isset($_POST['input'])){
							...
							if(mysqli_num_rows($cek) == 0){
									$insert = mysqli_query($koneksi, "INSERT INTO tb_pasien (no_badge, nama_pasien, jenis_kelamin, tgl_lahir,
									tempat_lahir, usia, agama, alamat, no_hp)
									VALUES('$no_badge', '$nama_pasien', '$jenis_kelamin', '$tgl_lahir', '$tempat_lahir', '$usia',
									'$agama', '$alamat', '$no_hp')")
									or die(mysqli_error());
									if($insert){
										echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Pasien Berhasil Di Simpan.</div>';
									}else{
										echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Ups, Data Pasien Gagal Di simpan !</div>';
									}
							}else{
								echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Pasien Sudah Ada..!</div>';
							}
						}
						?>
					<!-- End -->		
...
<div class="row">
     ...
     <div class="col-md-12 col-sm-12">
                         ...
                         <div class="alert alert-default alert-gradient alert-dismissible fade in" role="alert">
                           <strong><h4> Input Data Pasien</h4></strong>
                        </div>
                              ...
                              <div class="form">
                                  <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class="form-control" id="no_badge" name="no_badge" type="text" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="nama_pasien" class="control-label col-lg-2">Nama Pasien </label>
                                          <div class="col-lg-5">
                                              <input class="form-control" id="nama_pasien" type="text" name="nama_pasien" />
                                          </div>
                                      </div>
                                      <div class="form-group">
									...
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="tgl_lahir" type="text" name="tgl_lahir" required/>
                                          </div>
                                      </div>									  
									<div class="form-group ">
