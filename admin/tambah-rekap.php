  ...
  <!--<![endif]-->
	...
	<b><?php $tampil=mysqli_query($koneksi, "select * from tb_obat order by id_obat desc");
		...
		<!-- End --></span> Obat</p>
            ...
            <h1 class="page-title">Tambah Data Rekap Medis</h1>
                    <ul class="breadcrumb">
            <li><a href="index.php">Home</a> </li>
            <li class="active">Tambah Data Rekap Medis</li>
        </ul>
					...
					<?php
						if(isset($_POST['input'])){
							...
							$itemValues			=0;
							$query = "INSERT INTO tb_rekmed (tgl_rekmed, id_pasien, id_dokter, nama_obat, keterangan) VALUES ";
							$Value = "";
							$queryValue = "";
							...
							$queryValue .= "('" . $tgl_rekmed . "', '" . $id_pasien . "', '" . $id_dokter . "', '" . $Value . "', '" . $keterangan . "')";							
							$sql = $query.$queryValue;
							if($itemValues!=0) {
								$result = mysqli_query($koneksi, $sql)or die(mysqli_error());
								if($result){
									echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Rekap Medis Berhasil Di Simpan.</div>';
								}else{
									echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Ups, Data Rekap Medis Gagal Di simpan !</div>';
								}
							}
						}
						?>
...
<div class="row">
     ...
     <div class="col-md-12 col-sm-12">
                         ...
                         <div class="alert alert-default alert-gradient alert-dismissible fade in" role="alert">
                           <strong><h4> Input Data Rekap Medis</h4></strong>
                        </div>
                              ...
                              <div class="form">
                                  <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
									...
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <input class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="tgl_rekmed" type="text" name="tgl_rekmed" required/>
                                          </div>
                                      </div>
										 <div class="form-group">
						  ...
						  <div class="form-group ">
									...
									<div class="form-group ">
                                          <label for="keterangan" class="control-label col-lg-2">Keterangan </label>
                                              ...
                                              <textarea name="keterangan" id="keterangan" cols="60%" rows="4" ></textarea>
