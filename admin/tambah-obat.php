            ...
            <li class="active">Tambah Data Obat</li>
					...
					<?php
						if(isset($_POST['input'])){
							...
							$cek = mysqli_query($koneksi, "SELECT * FROM tb_obat WHERE nama_obat='$nama_obat'");
							if(mysqli_num_rows($cek) == 0){
								$insert = mysqli_query($koneksi, "INSERT INTO tb_obat (nama_obat, jenis_obat, kategori)
								VALUES('$nama_obat', '$jenis_obat', '$kategori')")
								or die(mysqli_error());
								if($insert){
									echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Obat Berhasil Di Simpan.</div>';
								}else{
									echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Obat Gagal Disimpan.</div>';									
								}
							}else{ 
								echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Obat Sudah Ada..!</div>';
							}
...
<div class="row">
     ...
     <div class="col-md-12 col-sm-12">
                         ...
                         <div class="alert alert-default alert-gradient alert-dismissible fade in" role="alert">
                           <strong><h4> Input Data Obat</h4></strong>
                        </div>
