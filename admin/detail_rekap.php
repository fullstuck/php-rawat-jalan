  ...
  <!--<![endif]-->
	...
	<b><?php $tampil=mysqli_query($koneksi, "select * from tb_obat order by id_obat desc");
		...
		<!-- End --></span> Obat</p>
            ...
            <h1 class="page-title">Detail Data Rekap Medis</h1>
                    <ul class="breadcrumb">
            <li><a href="index.php">Home</a> </li>
            <li class="active">Detail Data Rekap Medis</li>
        </ul>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              Detail Data Rekap Medis
                          </header>
						  <!-- Fungsi Menampilkan Data dari Database -->	
									
						<?php
						$kodeRekMed = $_GET["kd"];
						$query = mysqli_query($koneksi, "SELECT tb_rekmed.tgl_rekmed, tb_pasien.nama_pasien, tb_dokter.nama_dokter, tb_obat.nama_obat, keterangan	
									FROM tb_pasien, tb_dokter, tb_rekmed, tb_obat
									WHERE tb_rekmed.id_pasien=tb_pasien.id_pasien AND tb_rekmed.id_dokter=tb_dokter.id_dokter
									AND tb_rekmed.id_obat=tb_obat.id_obat AND id_rekmed = '". $kodeRekMed. "'");
					...
					<tbody>
					<tr>
                      <td><strong>Tanggal Rekap Medis</strong></td>
                      <td><span class="label label-danger"><?php echo $data['tgl_rekmed']; ?></span></td>
                      </tr>
                      <tr>
                      ...
                      <td colspan="1"><?php echo $data['nama_dokter']; ?></td>
                      </tr>
                      <tr>
                      <td><strong>Nama Obat</strong></td>
                      <td colspan="1"><?php echo $data['nama_obat']; ?></td>
                      </tr>
					  <td><strong>Keterangan</strong></td>
                      <td colspan="1"><?php echo $data['keterangan']; ?></td>
                      </tr>
                      </table>
                      <div class="text-right">
                      <a href="rekap.php" class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali </a>
					<!-- End -->
