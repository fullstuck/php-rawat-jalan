...
<!-- Small boxes (Stat box) -->
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Nama Obat & Jenis Obat & Kategori ' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='obat.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	</div>
              </div>
					...
					<?php
                    $query1="select * from tb_obat order by id_obat DESC";
                    
					// Fungsi Search
                    if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM  tb_obat 
	               where nama_obat like '%$qcari%' or jenis_obat like '%$qcari%' or kategori like '%$qcari%' ";
                    }
...
<p><a class="btn btn-primary icon-btn" href="tambah-obat.php"><i class="fa fa-plus"></i> Tambah Obat	</a></p>						  

<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">Data Obat</div>
			  ...
			  <!-- Fungsi Menampilkan data dari database -->	
				<?php 
                    ...
                    { $no++; ?>
								...
								<td><center><div id="thanks"><a class="btn btn-sm btn-info" data-placement="bottom" data-toggle="tooltip" title="Edit Obat" href="edit-obat.php?hal=edit&kd=<?php echo $data['id_obat'];?>"><span class="fa fa-pencil"> Edit</span></a>  
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_obat'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Obat" href="hapus-obat.php?hal=hapus&kd=<?php echo $data['id_obat'];?>"><span class="fa fa-trash-o"> Delete</span></a></center></td></tr></div>
                 <?php   
              } 
              ?>     
            <!-- End -->  
