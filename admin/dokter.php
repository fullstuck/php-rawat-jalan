...
<body class=" theme-blue">
 ...
 <!-- Small boxes (Stat box) -->
	       ...
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Nama Dokter & Spesialisasi ' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='dokter.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	</div>
              </div>
					...
					<?php
                    $query1="select * from tb_dokter order by id_dokter DESC";
                    
					// Fungsi Search
                    if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM  tb_dokter 
	               where nama_dokter like '%$qcari%' or spesialisasi like '%$qcari%' ";
                    }
                    ...
                    ?>
					 ...
					 <!-- End -->				
						  ...
						  <p><a class="btn btn-primary icon-btn" href="tambah-dokter.php"><i class="fa fa-plus"></i> Tambah Dokter	</a></p>

<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">Data Dokter</div>
			  ...
			  <!-- Fungsi Menampilkan data dari database -->	
				<?php 
                    ...
                    { $no++; ?>
								...
								<td><center><?php echo $data['spesialisasi'];?></center></td>
								<td><center><?php echo $data['alamat'];?></center></td>
								<td><center><?php echo $data['no_hp']; ?></center></td>
								
								<td><center><div id="thanks"><a class="btn btn-sm btn-info" data-placement="bottom" data-toggle="tooltip" title="Edit Dokter" href="edit-dokter.php?hal=edit&kd=<?php echo $data['id_dokter'];?>"><span class="fa fa-pencil"> Edit</span></a>  
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_dokter'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Dokter" href="hapus-dokter.php?hal=hapus&kd=<?php echo $data['id_dokter'];?>"><span class="fa fa-trash-o"> Delete</span></a></center></td></tr></div>
                 <?php   
              } 
              ?>     
            <!-- End -->  
